...
<div class="page">
	<?php $__FOR_START_17855__=1;$__FOR_END_17855__=$total+1;for($i=$__FOR_START_17855__;$i < $__FOR_END_17855__;$i+=1){ ?><a href="javascript:void(0)" page="<?php echo ($i); ?>" class="page_comment <?php echo ($page == $i ? 'select' : ''); ?>"><?php echo ($i); ?></a><?php } ?>
</div>